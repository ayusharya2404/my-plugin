...
module.exports = {
  ...
  plugins: [
    ...
    ".stylish-quote": {
      ...
      backgroundImage: "linear-gradient(90deg, rgba(165, 180, 252, 0.2), transparent)",
    ...
    ".text-8xl": {
      fontSize: theme("fontSize.8xl")[0],
        ...
        ".smart-text": {
          ...
          color: theme("smartText.base.color", theme("colors.gray.800", "#1f2937")),
          ...
          "& p": {
            marginBottom: theme("smartText.contentTypes.article.paragraphSpacing", "1em"),
          },
          "& ul": {
            paddingLeft: "1.5em",
            marginBottom: theme("smartText.contentTypes.article.paragraphSpacing", "1em"),
            listStyleType: theme("smartText.contentTypes.article.listStyle", "disc"),
            "& li": { 
              marginBottom: theme("smartText.contentTypes.article.listSpacing", "0.5em") 
            },
          },
          "& ol": {
            paddingLeft: "1.5em",
          ...
          "& a": {
            color: theme("smartText.contentTypes.article.linkColor", theme("colors.blue.600", "#2563eb")),
          ...
          "& code": {
            fontFamily: theme("smartText.contentTypes.documentation.codeFontFamily", "ui-monospace, monospace"),
            backgroundColor: theme("smartText.contentTypes.documentation.codeBackground", theme("colors.gray.100", "#f3f4f6")),
            padding: theme("smartText.contentTypes.documentation.codePadding", "0.2em 0.4em"),
            borderRadius: theme("smartText.contentTypes.documentation.codeRadius", "0.25rem"),
          },
          "& pre": {
            fontFamily: theme("smartText.contentTypes.documentation.codeFontFamily", "ui-monospace, monospace"),
            backgroundColor: theme("smartText.contentTypes.documentation.codeBackground", theme("colors.gray.100", "#f3f4f6")),
          ...
          "@media (prefers-color-scheme: dark)": {
            color: theme("smartText.dark.color", theme("colors.gray.300", "#d1d5db")),
            "& a": { 
              color: theme("smartText.dark.linkColor", theme("colors.blue.400", "#60a5fa")) 
            },
            "& code": { 
              backgroundColor: theme("smartText.dark.codeBackground", theme("colors.gray.800", "#1f2937")) 
            },
            "& pre": { 
              backgroundColor: theme("smartText.dark.codeBackground", theme("colors.gray.800", "#1f2937")) 
            },
        ...
        ".smart-text-documentation": {
          "& p": { 
            marginBottom: theme("smartText.contentTypes.documentation.paragraphSpacing", "0.75em") 
          },
          "& h2": {
            fontSize: theme("smartText.headings.h2.fontSize", "1.875rem"),
            lineHeight: theme("smartText.headings.h2.lineHeight", "1.2"),
        ...
        ".smart-text-relaxed": {
          ...
          letterSpacing: theme("smartText.visualStyles.relaxed.letterSpacing", "0.01em"),
          "& p": { 
            marginBottom: theme("smartText.visualStyles.relaxed.paragraphSpacing", "1.5em") 
          },
        },
        
        ".smart-text-compact": {
          lineHeight: theme("smartText.visualStyles.compact.lineHeight", "1.3"),
          letterSpacing: theme("smartText.visualStyles.compact.letterSpacing", "-0.01em"),
          "& p": { 
            marginBottom: theme("smartText.visualStyles.compact.paragraphSpacing", "0.5em") 
          },
        },
        ...
        ".smart-text-animate-fade-in": {
          ...
          animation: `smartTextFadeIn ${theme("smartText.animations.fadeIn.duration", "1s")} ${theme("smartText.animations.fadeIn.timing", "ease-in")} ${theme("smartText.animations.fadeIn.delay", "0s")}`,
        },
        ...
        ".smart-text-animate-slide-in": {
          ...
          animation: `smartTextSlideIn ${theme("smartText.animations.slideIn.duration", "0.7s")} ${theme("smartText.animations.slideIn.timing", "cubic-bezier(0.16, 1, 0.3, 1)")} ${theme("smartText.animations.slideIn.delay", "0s")}`,
        },
